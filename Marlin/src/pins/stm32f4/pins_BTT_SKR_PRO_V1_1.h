...
#define Y_STEP_PIN                          PE13    // PE11  Y and Z exchanged for dual drive on Y
#define Y_DIR_PIN                           PC2     // PE8
#define Y_ENABLE_PIN                        PC0     // PD7
 #ifndef Y_CS_PIN
  #define Y_CS_PIN                          PB9     // PB8
#endif

#define Z_STEP_PIN                          PE11     // PE13
#define Z_DIR_PIN                           PE8      // PC2
#define Z_ENABLE_PIN                        PD7      // PC0
#ifndef Z_CS_PIN
  #define Z_CS_PIN                          PB8      // PB9
#endif
...
//
  ...
  #define Y_SERIAL_TX_PIN                   PE1     // PE3
  #define Y_SERIAL_RX_PIN                   PE1     // PE3

  #define Z_SERIAL_TX_PIN                   PE3     // PE1
  #define Z_SERIAL_RX_PIN                   PE3     // PE1
