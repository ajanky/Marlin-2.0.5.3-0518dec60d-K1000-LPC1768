...
//
#define X_MIN_PIN          P1_24   // 4k7 pullup to 3.3V
#define X_MAX_PIN          P1_25   // = Y2MIN - 4k7 pullup to 3.3V
#define Y_MIN_PIN          P1_26   // 4k7 pullup to 3.3V
#define Y_MAX_PIN          -1   // 10k pullup to 3.3V, 1K series
#define Z_MIN_PIN          P1_28   // 4k7 pullup to 3.3V
#define Z_MAX_PIN          -1   //  4k7 pullup to 3.3V

#ifndef Z_MIN_PROBE_PIN
  #define Z_MIN_PROBE_PIN  P1_1   // ZPRB - was NOTAUS
#endif
...
#define X2_STEP_PIN        P1_20
#define X2_DIR_PIN         P1_19
#define X2_ENABLE_PIN      P1_18
...
//
#define TEMP_BED_PIN        P0_25_A2   // A2 (TH1)
#define TEMP_0_PIN          P0_23_A0   // A0 (TH2)
#define TEMP_1_PIN          P0_24_A1   // A1 (TH3)
